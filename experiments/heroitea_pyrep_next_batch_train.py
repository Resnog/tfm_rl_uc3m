from agent import agentExpectedSarsa, agentQL
...
"""
COMMENT THIS ONLY IF YOU WANT TO TRAIN FURTHER WITH PREVIOUS RESULTS
"""
#----------------------
# Load agent's q_table
#----------------------
saved_q_table = np.load(save_path + "first/"+ "agent_ql_values.npy")
...
plt.savefig(save_path + "second/" + "reward_sum_curve.png")
plt.show()
